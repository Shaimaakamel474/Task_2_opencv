...
class ActiveContourModel:
    ...
    def visualize_evolution(self, original_image, step=1, save_path="contoured.png"):
...
def run_active_contour_demo(image_path, center_x=None, center_y = None, radius = None, alpha=0.1, beta=0.1, gamma=0.3,
    ...
    img = gaussian_filter(original_image, sigma=1)  # Smooth the image
    edges = canny(img, sigma=2)  # Detect edges using Canny
    ...
    print(f"Radius: {min(img.shape) // 2}")
    ...
    snake = ActiveContourModel(
        ...
        w_line=0.0, w_edge=1.0,  # Emphasize edge energy
    ...
    if visualize:
        snake.visualize_evolution(original_image, "contoured.png")
...
if __name__ == "__main__":
    ...
    # # Create animation of the contour evolution
    # animate_contour_evolution(
    #     image_path,
    #     results['contour_history'],
    #     save_path=None  # Set to None to display without saving
    # )
